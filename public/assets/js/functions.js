;(function($) {
    ...
    var MERCADO_JS = {
    	init: function(){
            ...
            this.mercado_remove_product_in_wishlist();
        ...
        mercado_remove_product_in_wishlist: function(){
			if($(".products-cart .pr-cart-item").length > 0){
				$(document).on('click', '.pr-cart-item .delete .btn-wish-delete', function(event) {
					event.preventDefault();
