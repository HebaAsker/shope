...
<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('view_category')? 'active bg-gradient-primary': '' }}" href="/view_category">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('add_category')? 'active bg-gradient-primary': '' }}" href="/add_category" >
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link text-white {{  Request::is('view_product')? 'active bg-gradient-primary': ''}}" href="/view_product">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('add_product')? 'active bg-gradient-primary': '' }} " href="/add_product">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
