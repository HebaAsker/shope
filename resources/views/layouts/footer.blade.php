                                        ...
                                        <div class="wrap-contact-detail">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <p class="contact-txt"> (+20) 102 093 790 1 </p>
                                                </li>
                                                <li>
                                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                                    <p class="contact-txt">hebaasker1772022@gmail.com</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="wrap-footer-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-hotline-footer">
                                            ...
                                            <b class="phone-number">(+20) 102 093 790 1</b>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="coppy-right-box">
                    <div class="container">
                        <div class="coppy-right-item item-left">
                            <p class="coppy-right-text">Copyright © 2022 Heba Asker. All rights reserved</p>
                        </div>
