                                    ...
                                    <div class="product product-style-3 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <form action="{{ url('/addToCart') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" value="{{ $item->selling_price }}" name="selling_price" class="selling_price">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                        ...
                        <div class="widget mercado-widget filter-widget price-filter">
                            ...
                            <div class="widget-content">
                                ...
                                <form action="/filter" method="GET" id="form-search-top" name="form-search-top">
                                    <p>
                                        <label for="amount">Price:</label>
                                        <input type="text" id="amount" name="filter">
                                        ...
                                        @foreach ( $popular_product as $product)
                                            <div class="product product-widget-style">
                                                <div class="thumbnnail">
                                                    <a href="{{ url('product detail/'.$item->id) }}" title="{{ $product->name }}">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    @if ($product->tax==0)
                                                        <div class="wrap-price"><span class="product-price">${{ $product->orignal_price }}</span></div>
                                                    @else
